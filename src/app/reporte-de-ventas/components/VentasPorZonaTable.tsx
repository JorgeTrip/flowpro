...
export const VentasPorZonaTable = ({ ventasPorZona, cantidadesPorZona }: VentasPorZonaTableProps) => {
    ...
    // Inicializar zonas seleccionadas
    React.useEffect(() => {
    ...
    const datosProcesados = useMemo(() => {
        ...
        return datos;
    }, [ventasPorZona, cantidadesPorZona, zonasSeleccionadas, mostrarCantidad, ordenAscendente]);
    ...
    const exportarDatos = () => {
        const headers = mostrarCantidad 
            ? ['Zona', 'Cantidad A', 'Cantidad X', 'Total Cantidad']
            : ['Zona', 'Importe A', 'Importe X', 'Total Importe'];
        ...
        a.href = url;
        a.download = `ventas-por-zona-${mostrarCantidad ? 'cantidad' : 'importe'}.csv`;
        a.click();
