...
export default function EstimarDemandaPage() {
  const { step, isLoading, error } = useEstimarDemandaStore();
  ...
  return (
    <ModuleLayout
      titulo="Estimar Demanda vs. Stock"
      descripcion="Analice la demanda de productos contra el stock actual para optimizar el inventario."
      breadcrumbs={[{ nombre: 'Dashboard', href: '/' }, { nombre: 'Estimar Demanda' }]}
    >
